...
public class SideScroller extends MasterLevel{
	
	public SideScroller(SavingController saving_controller, String level_location) {
		super(saving_controller, level_location);
